...
const Contact = () => {
  return (
    <div className="flex flex-col justify-center items-center" id="Contact">
      <h2 className="text-sky-300 text-5xl font-bold mt-3 mb-6 text-center">Want To Get In Touch?</h2>
      <p className="mb-2 p-8 text-start">I&apos;d love to hear from you! Whether you&apos;re interested in discussing exciting opportunities, collaborating on innovative projects, or just connecting to share ideas, feel free to reach out.</p>
