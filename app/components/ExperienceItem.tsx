...
const ExperienceItem = ({ experienceData }: { experienceData: ExperienceData }) => {
  return (
    <div className='flex flex-col md:flex-row justify-center items-start md:items-center mb-6 md:mb-12 shadow-xl rounded-xl p-5'>
        <Image src={experienceData.imageName} alt="McMaster Start Coding" width={100} height={100} className="mr-4 rounded-xl"/>
        <div>
